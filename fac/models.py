...
def detalle_fact_guardar(sender, instance, **kwargs):
    facura_id = instance.factura.id
    id_producto = instance.producto.id
    
    enc = FacturaEnc.objects.get(pk=facura_id)
    if enc:
        sub_total = FacturaDet.objects \
                        .filter(factura=facura_id) \
