...
CERT = PYAFIPWS_DIRS+'/costa.crt'
PRIVATEKEY = PYAFIPWS_DIRS+"/costa.key"
CACHE = os.path.join(PYAFIPWS_DIRS, 'cache')
CONF_PDF = dict(
    LOGO= os.path.join(PYAFIPWS_DIRS, 'plantillas') + "/logo.png",
...
def facturar(registros):
    ...
    for reg in registros:
        ...
        ok = cbte.generar_pdf(fepdf, PYAFIPWS_DIRS+"/factura_{}.pdf".format(nro))
