...
from .views import ProductoList, ProductoDetalle, NotificacionList, NotificacionListWeb, ProvinciaList, ClienteList, Agencias_User
...
urlpatterns = [
    ...
    path('v1/agencias/user/<str:codigo>',Agencias_User.as_view(), name='agencias_user'),
]
